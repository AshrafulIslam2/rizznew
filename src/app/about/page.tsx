...
const FALLBACK: AboutData = {
  ...
  values: [
    { title: "Genuine Leather. Always.", body: "Every single piece we make uses real leather — full-grain, vegetable-tanned, suede, or embossed calfskin. No bonded leather, no PU, no compromise." },
    { title: "Made by Hand.", body: "Our craftsmen cut, stitch, and finish each piece individually. There are no shortcuts in how we work — machine stitching is used only where it adds structural strength." },
    { title: "Direct to You.", body: "We sell directly to the customer, with no middlemen. That means better pricing, honest communication, and a relationship we can stand behind." },
    { title: "Made to Last.", body: "A Rizz loafer or wallet is not a seasonal purchase. Properly cared for, our pieces improve with age. We back that with a one-year craftsmanship warranty." },
  ],
  timeline: [
        ...
        <section className="relative overflow-hidden">
          ...
          <div className="absolute inset-0 flex items-center justify-center text-center px-5">
            <div>
              ...
              <p className="mt-4 text-[10px] uppercase tracking-[0.4em] text-[var(--gold-dim)]">— {about.quoteAuthor}</p>
            </div>
          </div>
        </section>
