...
const pageDescription =
  "Rizz Leather is a leather sandals factory in Bangladesh, based in Chittagong (Bakolia). MOQ 12 pairs. Ready stock dispatch in 3-4 days and made-to-order lead time 15-30 days. Leather sandals for men and women. Wholesale, OEM and private label with logo embossing and printing. Supply across Bangladesh including Dhaka.";

export async function generateMetadata(): Promise<Metadata> {
  const url = `${getBaseUrl()}/leather-sandals-factory-bangladesh`;
...
const productGroups = [
  {
    ...
    points: [
      "Wholesale supply for retailers and wholesalers",
  ...
  },
  {
    ...
    points: [
      "Wholesale supply for shop owners and resellers",
...
const qualityChecks = [
  ...
  "Size consistency and pairing check",
  "Visual defect and symmetry check",
  "Packaging check before dispatch"
];

const faqs = [
  {
    q: "Where is your leather sandals factory located?",
    a: "Our manufacturing base is in Bakolia, Chittagong-4203, Bangladesh."
  },
  {
    q: "What is your MOQ?",
    a: "MOQ is 12 pairs."
  ...
  },
  {
    ...
    a: "Yes. We supply wholesale leather sandals to Dhaka and other cities across Bangladesh."
  },
  {
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.12fr_0.88fr] lg:items-end lg:py-24">
          <div className="space-y-6">
            ...
            <p className="max-w-3xl text-base leading-relaxed text-[#c0c5cf] sm:text-lg lg:text-2xl">
              Rizz Leather is a leather sandals factory in Bangladesh, based in Chittagong, Bakolia. We manufacture leather sandals for men and women
              and support wholesale supply, ready stock dispatch, and made-to-order production.
            </p>
      ...
      <section id="overview" className="py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="grid gap-10 lg:grid-cols-[1fr_0.92fr] lg:items-start">
            <div className="space-y-6">
              <div>
                ...
                <h2 className="mt-3 text-3xl font-semibold text-[#f4eee1] sm:text-4xl lg:text-5xl">
                  Factory-Direct Leather Sandals Manufacturing in Bangladesh
                </h2>
              </div>
              <p className="text-base leading-relaxed text-[#adb2bd] sm:text-lg">
                If you are looking for a leather sandals factory in Bangladesh, you need a manufacturer who can deliver consistent finishing, flexible
                quantities, and clear dispatch and lead times. Rizz Leather manufactures in Chittagong and supplies leather sandals across Bangladesh,
                including Dhaka.
              </p>
            </div>
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
              {[
                "Factory-backed production in Chittagong, Bangladesh",
                "Ready stock and made-to-order flexibility",
                "Men's and women's category support",
                "Wholesale and private label supply"
              ].map((item) => (
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <article className="surface-panel rounded-2xl border p-6 sm:p-8">
            ...
            <p className="mt-4 text-base leading-relaxed text-[#adb2bd] sm:text-lg">
              We keep ready stock for selected leather sandals designs and sizes to support fast supply. Typical dispatch time is 3-4 days after
              confirmation, subject to availability.
            </p>
            <ul className="mt-5 space-y-3 text-base text-[#d8dde5]">
              <li>MOQ: 12 pairs</li>
              <li>Best for quick replenishment and repeat wholesale buying</li>
            </ul>
          </article>
        </div>
      </section>
      ...
      <section id="made-to-order" className="border-y border-[var(--hairline-accent)] py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <article className="surface-panel rounded-2xl border p-6 sm:p-8">
            ...
            <p className="mt-4 text-base leading-relaxed text-[#adb2bd] sm:text-lg">
              If you need exclusive styles or specific finishing for your market, we support made-to-order leather sandals production. Typical lead
              time is 15-30 days depending on design complexity, materials, and order details.
            </p>
            <ul className="mt-5 space-y-3 text-base text-[#d8dde5]">
              <li>MOQ: 12 pairs</li>
              <li>New design development or modifications from existing designs</li>
            </ul>
          </article>
        </div>
      </section>
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[0.95fr_1.05fr] lg:items-start">
          <div className="space-y-6">
            ...
            <p className="text-base leading-relaxed text-[#adb2bd] sm:text-lg">
              ...
              maintain consistent output for wholesale buyers.
            </p>
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
            ...
            {[
              {
                ...
                desc: "Leather selection based on buyer requirement and availability."
              },
              {
                title: "Color and finish",
                desc: "Options aligned with your target market."
              },
              {
                title: "Sole options",
                desc: "Selected based on design and comfort needs."
              },
              {
                title: "Dispatch checks",
                desc: "Packaging and final visual checks before release."
              }
            ].map((item) => (
      ...
      <section id="oem-private-label" className="border-y border-[var(--hairline-accent)] py-14 sm:py-16">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1fr_0.95fr]">
          <article className="surface-panel rounded-2xl border p-6 sm:p-8">
            ...
            <p className="mt-4 text-base leading-relaxed text-[#adb2bd] sm:text-lg">
              We support OEM/private label manufacturing so you can sell leather sandals under your own brand. Send your new design or choose an
          ...
          <article id="delivery" className="surface-panel rounded-2xl border p-6 sm:p-8">
            ...
            <p className="mt-4 text-base leading-relaxed text-[#adb2bd] sm:text-lg">
              We supply wholesale leather sandals across Bangladesh from our Chittagong base, including Dhaka.
            </p>
            <p className="mt-4 text-base leading-relaxed text-[#adb2bd] sm:text-lg">
              Dhaka-focused wholesale page:{" "}
      ...
      <section id="faq" className="py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-3 text-3xl font-semibold text-[#f4eee1] sm:text-4xl lg:text-5xl">Leather Sandals Factory in Bangladesh</h2>
          </div>
