...
const pageTitle = "Leather Sandals Wholesaler in Dhaka | MOQ 12 Pairs | Rizz";
const pageDescription =
  "Need a leather sandals wholesaler in Dhaka? Rizz Leather supplies wholesale leather sandals to Dhaka from our Chittagong (Bakolia) factory base. MOQ 12 pairs. Ready stock dispatch 3-4 days, made-to-order lead time 15-30 days. Men's and women's leather sandals. Logo embossing and printing for private label.";

export async function generateMetadata(): Promise<Metadata> {
  const url = `${getBaseUrl()}/leather-sandals-wholesaler-dhaka`;
...
const productGroups = [
  {
    ...
    points: [
      "Wholesale supply for retail shops and resellers in Dhaka",
      "Design options based on availability and specification",
      "Size run planning for your customer segment"
    ]
  },
  {
    title: "Women's leather sandals (wholesale)",
    points: [
      "Wholesale supply for Dhaka retailers",
      "Casual and fashion-focused variations depending on design",
      "Finishing options based on your target market"
    ]
  }
];
...
const faqs = [
  {
    ...
    a: "Our factory is in Chittagong, Bakolia. We supply wholesale leather sandals to Dhaka."
  },
  {
  ...
  {
    q: "Do you accept made-to-order leather sandals for Dhaka?",
    a: "Yes. Typical lead time is 15-30 days."
  },
  {
    q: "Do you supply leather sandals for both men and women?",
    a: "Yes. We supply leather sandals for men and women."
  },
  {
    q: "Do you offer private label with logo embossing and printing?",
    a: "Yes. We support private label with logo embossing and logo printing."
  }
];

export default function LeatherSandalsWholesalerDhakaPage() {
  return (
    <main>
      <LandingStructuredData
        path="/leather-sandals-wholesaler-dhaka"
        title={pageTitle}
        faqs={faqs}
        breadcrumbs={[
          { name: "Home", item: "/" },
          { name: "Leather Sandals Wholesaler in Dhaka", item: "/leather-sandals-wholesaler-dhaka" }
        ]}
      />
        ...
        <div className="relative mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 lg:grid-cols-[1.12fr_0.88fr] lg:items-end lg:py-24">
          <div className="space-y-6">
            ...
            <p className="max-w-3xl text-base leading-relaxed text-[#c0c5cf] sm:text-lg lg:text-2xl">
              Need a reliable leather sandals wholesaler in Dhaka? Rizz Leather supplies wholesale leather sandals to Dhaka from our Chittagong,
              Bakolia manufacturing base with ready stock, made-to-order, and private label options.
            </p>
      ...
      <section id="truth" className="py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="grid gap-10 lg:grid-cols-[1fr_0.92fr] lg:items-start">
            <div className="space-y-6">
              <div>
                <p className="text-xs uppercase tracking-[0.35em] text-[#cdbb8f]">Location Clarity</p>
                <h2 className="mt-3 text-3xl font-semibold text-[#f4eee1] sm:text-4xl lg:text-5xl">Factory Location and Dhaka Wholesale Supply</h2>
              </div>
              <p className="text-base leading-relaxed text-[#adb2bd] sm:text-lg">
                To keep things clear: our factory is located in Chittagong, Bakolia. We arrange wholesale supply and delivery to Dhaka for retailers,
                shop owners, and wholesalers.
              </p>
              <p className="text-base leading-relaxed text-[#adb2bd] sm:text-lg">
                This gives you factory-backed supply with flexible ordering and transparent lead-time planning.
              </p>
            </div>

            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-1">
              {[
                "Factory in Chittagong, delivery support for Dhaka",
                "Ready stock and made-to-order options",
                "Men's and women's leather sandal categories",
                "Private label support with logo services"
              ].map((item) => (
      ...
      <section id="products" className="border-y border-[var(--hairline-accent)] py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mb-8 flex flex-col gap-4 sm:mb-10 sm:flex-row sm:items-end sm:justify-between">
            <div>
              ...
              <h2 className="mt-3 text-3xl font-semibold text-[#f4eee1] sm:text-4xl lg:text-5xl">
                Leather Sandals Wholesale for Dhaka Buyers
              </h2>
            </div>
            <p className="max-w-xl text-base text-[#adb2bd] sm:text-right sm:text-lg">
              Segment-based wholesale support for men and women with flexible stock planning.
            </p>
          </div>

          <div className="grid gap-5 lg:grid-cols-2">
            {productGroups.map((group) => (
              <article key={group.title} className="surface-panel rounded-2xl border p-6">
          ...
          <p className="mt-8 text-base text-[#adb2bd] sm:text-lg">
            Bangladesh-wide leather wholesale page:{" "}
      ...
      <section id="ready-stock" className="py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <article className="surface-panel rounded-2xl border p-6 sm:p-8">
            ...
            <h2 className="mt-3 text-3xl font-semibold text-[#f4eee1] sm:text-4xl">Ready Stock Leather Sandals for Dhaka (3-4 Days)</h2>
            <p className="mt-4 text-base leading-relaxed text-[#adb2bd] sm:text-lg">
              If you need fast replenishment, you can order ready stock leather sandals for Dhaka delivery, subject to availability. Typical dispatch
              time is 3-4 days after order confirmation.
            </p>
            <ul className="mt-5 space-y-3 text-base text-[#d8dde5]">
              <li>MOQ: 12 pairs</li>
              <li>Best for shops needing quick stock refill</li>
            </ul>
          </article>
        </div>
      </section>
      ...
      <section id="made-to-order" className="border-y border-[var(--hairline-accent)] py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <article className="surface-panel rounded-2xl border p-6 sm:p-8">
            ...
            <h2 className="mt-3 text-3xl font-semibold text-[#f4eee1] sm:text-4xl">Made-to-Order Leather Sandals for Dhaka (15-30 Days)</h2>
            <p className="mt-4 text-base leading-relaxed text-[#adb2bd] sm:text-lg">
              For wholesalers and retailers who need specific designs or stable repeat SKUs, we support made-to-order leather sandals. Typical lead
              time is 15-30 days depending on the order.
            </p>
            <ul className="mt-5 space-y-3 text-base text-[#d8dde5]">
              <li>MOQ: 12 pairs</li>
              <li>New design development or modifications from existing styles</li>
            </ul>
      ...
      <section id="private-label" className="py-14 sm:py-16">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-[1fr_0.95fr]">
          <article className="surface-panel rounded-2xl border p-6 sm:p-8">
            <p className="text-xs uppercase tracking-[0.35em] text-[#cdbb8f]">Private Label / OEM</p>
            <h2 className="mt-3 text-3xl font-semibold text-[#f4eee1] sm:text-4xl">Private Label Leather Sandals for Dhaka Buyers</h2>
            <p className="mt-4 text-base leading-relaxed text-[#adb2bd] sm:text-lg">
              If you want to sell under your own brand in Dhaka, we support OEM/private label manufacturing for leather sandals. You can send your
              design or choose an existing style and request modifications.
            </p>
          ...
          <article id="delivery" className="surface-panel rounded-2xl border p-6 sm:p-8">
            ...
            <h2 className="mt-3 text-3xl font-semibold text-[#f4eee1] sm:text-4xl">Dhaka Ordering Support from Chittagong</h2>
            <p className="mt-4 text-base leading-relaxed text-[#adb2bd] sm:text-lg">
              Orders for Dhaka are supplied from our Chittagong base. Share your requirement, and we will confirm availability and a dispatch or
              production plan.
            </p>
            <p className="mt-4 text-base leading-relaxed text-[#adb2bd] sm:text-lg">
              Want factory details?{" "}
      ...
      <section id="faq" className="border-y border-[var(--hairline-accent)] py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-3 text-3xl font-semibold text-[#f4eee1] sm:text-4xl lg:text-5xl">Leather Sandals Wholesaler in Dhaka</h2>
          </div>
          ...
          <div className="grid gap-6 rounded-3xl border border-[var(--hairline-accent)] bg-[#080b13]/90 p-6 sm:p-8 lg:grid-cols-[1.15fr_0.85fr] lg:items-center">
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-base leading-relaxed text-[#adb2bd] sm:text-lg">
                For a fast quotation, send men or women category, sizes, total pairs, ready stock or made-to-order preference, and logo requirements.
              </p>
