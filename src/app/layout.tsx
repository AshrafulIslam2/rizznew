...
const defaultDescription =
  "Shop handcrafted genuine leather shoes,chelsi,office shoes, loafers,half loafers, sandals, belts & wallets from Chattogram,Bangladesh with nationwide Cash on Delivery.";
